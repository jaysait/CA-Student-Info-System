...
Developed a student information system for the unique approaches of a school primarily focused on a different approach to teaching, for obvious reasons couldn't put up the actual codebase, but have included selective code samples of my style at the time...good or bad, probably mostly bad :), and some screenshots showing examples of my work and listed the functionality developed.
